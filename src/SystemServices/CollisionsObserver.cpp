...
void CollisionsObserver::DetectCollisionsAndResolveKineticCollision(const std::vector<Particle *> &particles) {
    if (particles.empty()) {
        return;
    }
...
void CollisionsObserver::DetectCollisionsAndApplyPositionalCorrection(const std::vector<Particle *> &particles) {
    if (particles.empty()) {
        return;
    }
...
void CollisionsObserver::ResolveBoundaryCollisions(const std::vector<Particle *> &particles, int screenWidth,
                                                   int screenHeight) {
